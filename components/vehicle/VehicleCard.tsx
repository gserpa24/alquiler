        ...
        <div className="px-5 pb-5 sm:px-6 sm:pb-6 pt-0 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 xs:px-4 py-2 min-h-[40px] rounded-md bg-[#25D366] text-white text-xs font-semibold uppercase tracking-wider hover:bg-[#20bd5a] active:scale-[0.99] transition-all shadow-xs whitespace-nowrap"
            >
              <svg
