 ...
 * El link se genera en el cliente para evitar exponer el número en el HTML del servidor.
 */
export function WhatsAppCTA({
  ...
  const finalHref = isWa ? href : '/contact'
  const displayLabel = isWa ? label : 'Consultar disponibilidad'
      ...
      className={cn(
        ...
        variant === 'primary' && [
          isWa
            ...
            : 'bg-[#0A192F] text-white hover:bg-[#112240] shadow-xs',
        ],
        variant === 'outline' && [
          isWa
            ? 'border border-[#25D366]/40 text-[#128C7E] bg-white hover:border-[#25D366] hover:bg-[#25D366]/5'
            : 'border border-zinc-300 text-zinc-800 bg-white hover:border-zinc-400 hover:bg-zinc-50',
        ],
        className,
      )}
    >
