    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
      ...
      <header className="mb-10 pb-6 border-b border-zinc-200">
        ...
        <p className="mt-3 text-sm text-zinc-600 leading-relaxed">
          Ponemos a tu disposición nuestro Libro de Reclamaciones Virtual para registrar cualquier reclamo o queja respecto al servicio de alquiler de vehículos brindado por <strong>{config.brandName || 'AUTORUTA'}</strong> en {config.location || 'Tarapoto, San Martín, Perú'}.
        </p>
        ...
        <div className="mt-4 p-4 rounded-lg bg-zinc-50 border border-zinc-200 text-xs text-zinc-600 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div>
            ...
            <span>{config.brandName || 'AUTORUTA'}</span>
          </div>
          <div>
            ...
            <span className="flex items-center gap-1">
              ...
              {config.location || 'Tarapoto, San Martín, Perú'}
            </span>
          </div>
          {config.phone ? (
            <div>
